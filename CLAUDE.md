...
We are building custom microvm setup defined in flake.nix using https://github.com/microvm-nix/microvm.nix

Since it is a niche project, analyze code and read docs in cloned repo for details.
